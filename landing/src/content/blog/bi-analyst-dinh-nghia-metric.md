...
8 giờ sáng, chị Linh — BI analyst bốn năm kinh nghiệm tại một công ty thương mại điện tử tầm trung — mở LinkedIn và thấy cái tiêu đề ai cũng share tuần đó: *"AI viết SQL trong 3 giây, BI analyst sắp thành dĩ vãng."* Tim chị hụt một nhịp. Bốn năm chị sống bằng nghề viết truy vấn. Nếu một con AI làm được điều đó trong ba giây, thì chị còn lại gì?
...
Đây là chỗ nghề của chị Linh không chết đi, mà *lên một tầng*. Thay vì viết lại định nghĩa "doanh thu" trong từng truy vấn rời rạc, chị định nghĩa nó **đúng một lần** trong một lớp gọi là Semantic Layer — lớp ngữ nghĩa nằm giữa câu hỏi và database.
