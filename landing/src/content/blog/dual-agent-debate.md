...
Nhờ vậy, khi Agent B phản biện, nó không phản biện bằng cảm tính. Nó truy *đúng* định nghĩa đã khai báo, *đúng* danh sách bảng/cột có thật, *đúng* quan hệ giữa các bảng. Phản biện trở thành **đối chiếu với sự thật**, chứ không phải tranh cãi giữa hai phỏng đoán.

Tôi tin điểm này vì đang trực tiếp trải nghiệm nó. Là trưởng nhóm BI tại một ngân hàng tôi đang làm, tôi POC một semantic layer giữa rừng nghiệp vụ banking phức tạp - và bài học rõ nhất là: AI chỉ ngoan khi có neo. Thiếu định nghĩa chuẩn cho "dư nợ", "khách hàng hoạt động", LLM sẽ tự tin viết SQL gọi tới cột không tồn tại hay đoán bừa mẫu số, như tôi từng mổ xẻ trong [ảo giác AI: LLM bịa ra SQL](/blog/llm-bia-sql/). Hai agent cãi nhau mà không có lớp neo đó thì chỉ là hai cái loa cùng to mồm. Neo nghiệp vụ trước, tranh luận sau. Khác biệt này là lý do Semantix không phải "một chatbot cắm vào database" mà là một nền tảng AI Analytics - sự phân biệt mà bài [vì sao semantic layer khác hẳn chatbot cắm thẳng vào database](/blog/semantic-layer-vs-chatbot-database/) đào sâu.
