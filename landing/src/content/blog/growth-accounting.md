...
<div class="viz">
<div class="viz-chart" data-chart="growth" data-chart-data='{"periods":["T1","T2","T3","T4","T5"],"series":[{"name":"Giữ chân","key":"retained","values":[60,76,98,120,144]},{"name":"Quay lại","key":"resurrected","values":[14,14,12,12,12]},{"name":"Mới","key":"new","values":[32,34,32,30,30]},{"name":"Rời bỏ","key":"churned","values":[34,30,26,22,18],"negative":true}]}'></div>
