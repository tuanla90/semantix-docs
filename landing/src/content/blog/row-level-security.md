...
Tôi thấm chuyện này nhất từ khi làm BI ở một ngân hàng. Ở ngân hàng, "ai được thấy dữ liệu nào" không phải chuyện tiện hay không tiện, mà là chuyện một chi nhánh tuyệt đối không được nhìn số dư khách của chi nhánh khác, một cán bộ tín dụng chỉ được thấy hồ sơ mình phụ trách. Hồi đầu, phản xạ chung là khoá hết rồi xin-cho từng báo cáo — và quả nhiên chẳng ai "tự xem số" được. Khi đặt quy tắc lọc xuống đúng tầng dữ liệu theo danh tính, tôi mới dám đề xuất mở cùng một báo cáo cho nhiều người hơn hẳn, vì mỗi người được bảo đảm chỉ thấy đúng lát của mình.
