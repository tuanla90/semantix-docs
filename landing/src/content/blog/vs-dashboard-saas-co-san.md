...
- **Miễn phí kèm theo.** Bạn không trả thêm một đồng. Đã bán trên sàn là có báo cáo.
- **Không cài đặt, không cấu hình.** Mở lên là chạy. Không cần kết nối, không cần ai dựng.
- **Hiển thị xuất sắc dữ liệu của chính nền tảng đó.** Báo cáo Shopee biết rõ từng phí sàn (các khoản sàn thương mại điện tử thu trên mỗi đơn: phí cố định, phí thanh toán, phí voucher) của Shopee. TikTok Shop hiểu rõ luồng livestream và affiliate của TikTok Shop. Không ai hiểu dữ liệu Shopee bằng Shopee.

Nếu bạn chỉ bán trên một kênh và chỉ cần theo dõi vài chỉ số cơ bản, thành thật mà nói: bạn có thể chưa cần gì hơn. Đây không phải bài "dashboard sẵn dở". Đây là bài về **chuyện gì xảy ra khi doanh nghiệp bạn lớn hơn cái khung mà một dashboard sẵn được thiết kế để chứa.**
...
<svg viewBox="0 0 680 420" xmlns="http://www.w3.org/2000/svg" font-family="Inter, 'Segoe UI', Arial, sans-serif">
  <rect x="40" y="40" width="130" height="80" rx="10" fill="#0F172A" stroke="#1E293B" stroke-width="2"/>
  <text x="105" y="76" fill="#94A3B8" font-size="14" font-weight="700" text-anchor="middle">Shopee</text>
  <text x="105" y="98" fill="#475569" font-size="11" text-anchor="middle">chỉ thấy Shopee</text>
  <rect x="190" y="40" width="130" height="80" rx="10" fill="#0F172A" stroke="#1E293B" stroke-width="2"/>
  <text x="255" y="76" fill="#94A3B8" font-size="14" font-weight="700" text-anchor="middle">TikTok Shop</text>
  <text x="255" y="98" fill="#475569" font-size="11" text-anchor="middle">chỉ thấy TikTok</text>
  <rect x="340" y="40" width="130" height="80" rx="10" fill="#0F172A" stroke="#1E293B" stroke-width="2"/>
  <text x="405" y="76" fill="#94A3B8" font-size="14" font-weight="700" text-anchor="middle">KiotViet</text>
  <text x="405" y="98" fill="#475569" font-size="11" text-anchor="middle">chỉ thấy cửa hàng</text>
  <rect x="490" y="40" width="130" height="80" rx="10" fill="#0F172A" stroke="#1E293B" stroke-width="2"/>
  <text x="555" y="76" fill="#94A3B8" font-size="14" font-weight="700" text-anchor="middle">Ads / Kế toán</text>
  <text x="555" y="98" fill="#475569" font-size="11" text-anchor="middle">chỉ thấy phần mình</text>
  <line x1="105" y1="120" x2="300" y2="200" stroke="#334155" stroke-width="2"/>
  <line x1="255" y1="120" x2="320" y2="200" stroke="#334155" stroke-width="2"/>
  ...
  <rect x="150" y="316" width="380" height="64" rx="12" fill="#0F172A" stroke="#164E45" stroke-width="2"/>
  <text x="340" y="344" fill="#E2E8F0" font-size="14" font-weight="600" text-anchor="middle">"Kênh nào lãi thật sau phí sàn + ads + hoàn?"</text>
  <text x="340" y="366" fill="#34D399" font-size="13" font-weight="700" text-anchor="middle">→ một câu trả lời, xuyên cả bốn kênh</text>
</svg>
...
| Hỏi câu mới / xuyên kênh | Chỉ chỉ số dựng sẵn | **Hỏi tự do, vắt qua nhiều kênh** |
| Lãi thật sau phí sàn | Chỉ thấy phí của riêng kênh đó | Trừ phí sàn + ads + hoàn của cả cụm |
| Hỏi bằng tiếng Việt | Lọc / chọn trên giao diện | Gõ câu hỏi tiếng Việt tự nhiên |
...
*Đang mở bốn tab mỗi sáng để tự cộng doanh thu? Thử để một lớp gộp trả lời câu xuyên kênh đầu tiên bằng tiếng Việt. [Dùng thử Semantix miễn phí.](/docs/vi/free-trial/)*
